        ...
        <div class="col-xl-8 col-lg-12">
            <article class="postbox singel-post post format-image">
                <div class="postbox_thumb mb-35">
                    <img src="<?php echo base_url(); ?>uploads/<?php echo $aboutikorti->file ?>" alt="">
                </div>
                <div class="postbox_content bg-none">
                    <div class="post-meta mb-15">
                        <span><i class="far fa-calendar-check"></i> <?php echo GetUrlDate($aboutikorti->create_date) ?> </span>
                    </div>
                    <h3 class="blog-title">
                        <?php echo $aboutikorti->title ?>
                    </h3>
                    <div class="post-text mb-20">
                        <?php echo $aboutikorti->contents ?>
                    </div>
                </div>
            </article>
        </div>
